...
class ResourceCrudTestSuite:
    ...
    def test_get(self, Thing, random_things):
        ...
        for thing in random_things:
            ...
            assert ID_FIELD_NAME in thing_copy.internal.state
            assert REV_FIELD_NAME in thing_copy.internal.state
            assert (
                set(thing_copy.internal.state.keys())
                    == (field_names | {REV_FIELD_NAME, ID_FIELD_NAME})
            )
    ...
    def test_delete(self, Thing, random_things):
        ...
        for thing in random_things:
            thing_copy = Thing.get(thing._id, {ID_FIELD_NAME})
            assert thing_copy is not None
    ...
    def test_delete_many(self, Thing, random_things):
        ...
        for _ in range(10):
            ...
            thing_copies = Thing.get_many(thing_ids, {ID_FIELD_NAME})
