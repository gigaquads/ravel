...
#            elif child_name in target_biz_class.ravel.attributes.relationships:
#                # Recursively build query based on relationship
#                #
#                # NOTE: this check MUST be performed BEFORE the check for each
#                # child_name in target_biz_class.ravel.attributes
#                relationships = target_biz_class.ravel.attributes.relationships
...
#            elif child_name in target_biz_class.ravel.attributes:
#                biz_attr_query = self._build_ravel_attr_query(
#                    child_ast_node, target_biz_class, context
#                )
...
#        """
#        alias = ast_node.name
#        biz_attr = target_biz_class.ravel.attributes.by_name(ast_node.name)
