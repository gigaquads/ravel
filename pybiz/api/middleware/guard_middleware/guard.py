...
class Guard(object):
    ...
    a corresponding ApiProxy at runtime.
    ...
    def execute(self, context: Dict, *args, **kwargs) -> bool:
        """
        Determine whether ApiProxy request is authorized by performing any
        ...
        This implementation expects to be used with a ApiProxy with "user"
