...
from pybiz.api import Api

from .grpc_api_proxy import GrpcProxy
from ..grpc_client import GrpcClient

DEFAULT_HOST = '127.0.0.1'
DEFAULT_PORT = '50051'
DEFAULT_IS_SECURE = False
REGISTRY_PROTO_FILE = 'api.proto'
PB2_MODULE_PATH_FSTR = '{}.grpc.api_pb2'
PB2_GRPC_MODULE_PATH_FSTR = '{}.grpc.api_pb2_grpc'
...
class Grpc(Api):
    ...
    def on_bootstrap(self, rebuild=False, options: Dict = None):
        ...
        # get the python package containing this Api
    ...
    def _grpc_servicer_factory(self):
        ...
        module and derive a new subclass that inherits this Api's proxy
        objects as its interface implementation.
        """
        servicer_type_name = 'GrpcApiServicer'
        abstract_type = None
        ...
        servicer.add_to_grpc_server = (
            self.grpc.pb2_grpc.add_GrpcApiServicer_to_server
        )
